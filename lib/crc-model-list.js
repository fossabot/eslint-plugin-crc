 ...
 const CrcModelPrototypeVisitor = libCrc.crcModelPrototypeVisitor;
 ...
 (function() {
     ...
     * buffers.
     * @property {string} code The source code that was analyzed.
     * @property {object} astParsingOptions [Espree parsing options](https://github.com/eslint/espree/blob/master/espree.js#L624) defining how to tokenize the AST.
     * @property {object} ast The abstract syntax tree.
     * @property {array} models The `CrcModels` created.
     */
     class CrcModelList {
       ...
       */
          ...
          *
          * @example
          * const crcModelList = new CrcModelList(code);
          * const visitor = crcModelList.find({name: 'CrcModelPrototypeVisitor'});
          * crcModelList.getPrototypeOf(visitor);
          * // => reference to the CrcModelListVisitor
          *
          * @returns {CrcModel|object} The prototype of the crcModel, or `Object`.
          */
         getPrototypeOf(crcModel) {
             let isInvalidObject = (o) => _.isNil(o) || _.isError(o);
