 ...
 (function () {
     ...
     *
     * @property {string} name The source code identifier of the class or object to be modeled.
     * @property {array}  collaborators A collection of zero or more CrcModels that this object depends on.
     * @property {array}  references A collection of zero or more Espree Tokens representing where this object is used in the source code.
     * @property {object} identifier An Espree Identifier object.
     * @property {array}  responsibilities A list of data this object must maintain and/or operations it must perform.
     * @property {object} declaration The Espree Identifier that represents "where" this object was declared into being.
     * @property {object} superClass The `prototype` of the object being modeled. Defaults to `Object`.
     *
     */
     class CrcModel {
        /**
         * Create a Class-Responsibility-Collaboration model.
         ...
         *
         * @returns {CrcModel} A CrcModel object.
         */
